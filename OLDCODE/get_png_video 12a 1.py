...
class VideoPlayer:
    ...
    def extract_video(self):
        ...
        # -ss before -i resets timestamps; use -t (duration) not -to (end time)
        common_input = [
        ...
        try:
            ...
            if not self._needs_video_reencode(speed):
                ...
                ok_av, err_av = self._run_ffmpeg(av_cmd, "Video+audio extract")
