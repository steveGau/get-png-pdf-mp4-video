...
class VideoPlayer:
    ...
    def setup_gui(self):
        ...
        self.duration_entry_var = tk.StringVar(value="00:00:10")
        ...
        self.interval_entry_var = tk.StringVar(value="00:01:000")
    ...
    def auto_extract_frames(self):
        ...
        # Get start time from "Go to time" entry
        start_time_str = self.time_entry_var.get().strip()
        start_ms = self.time_to_ms(start_time_str)
        
        if start_ms is None or start_ms < 0:
            messagebox.showwarning("Invalid Start Time", "Please enter a valid start time in format HH:MM:SS")
            return
